...
function addBodyListener() {
    document.body.addEventListener('keydown', async (event) => {
        ...
        if (event.key === 'Enter') {
            ...
            const activeSubMenuItem = Array.from(activeMenuItem.subMenuItemContainer.children)[activeMenuItem.activeSubMenuItemIndex];
  
            // Vérifie si le sous-item sélectionné a un lien
            const link = activeSubMenuItem.dataset.href;
            if (link) {
